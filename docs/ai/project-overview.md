...
## Current Phase
This repository currently implements **Prompt 0.1 — initial architecture and standards scaffold**.
...
- centralized config for env, routes, metadata, and feature flags
- starter error, loading, and not-found boundaries
...
src/
  ...
  config/         env, metadata, routes, feature flags
